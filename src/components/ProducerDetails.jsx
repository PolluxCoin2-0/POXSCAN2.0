...
const ProducerDetails = () => {
  ...
  return (
    <div className="text-white ">
      ...
      <div className="pb-6">
        ...
        <div className="flex flex-col items-start space-y-4 lg:space-y-0 lg:flex-row lg:justify-between lg:items-center">
  ...
  <p>397)</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:gap-4">
        <div className="bg-[#151515] border-[1px] border-[#434343] rounded-3xl px-6 py-5 my-2 md:my-3 shadow-lg">
        ...
        <div className="bg-[#151515] border-[1px] border-[#434343] rounded-3xl px-2 md:px-6 py-5 my-3 shadow-lg">
