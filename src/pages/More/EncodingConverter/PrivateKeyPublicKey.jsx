  ...
  return (
    <div className="bg-[#151515] border border-[#434343] rounded-3xl px-8 py-6 flex flex-col lg:flex-row items-center justify-evenly gap-8 mt-2 mb-8">
      ...
      <div className="flex-1 relative">
        <p className="text-white/80 mb-2 font-semibold text-lg">Public Key</p>
        <textarea
      ...
      <div className="flex-1 relative">
       ...
       <div className="flex flex-row items-center space-x-4 py-2">
        ...
        <textarea
          ...
          id="polluxevmaddress2"
          rows={6}
          className="w-full resize-none bg-[#151515] outline-none text-white border border-[#434343] rounded-xl px-6 py-4 my-1"
...
export default PrivateKeyPublicKey;
